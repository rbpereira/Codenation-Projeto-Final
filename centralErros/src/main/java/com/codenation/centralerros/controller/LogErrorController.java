...
public class LogErrorController {
	...
	@GetMapping()
	public List<LogErrorDTO> findAll() throws Exception {
		List<LogErrorDTO> listError = logErrorService.findAll();
		if(listError.isEmpty()) {
			throw new Exception("Até o momento não foram cadastrados logs.");
		}
		return listError;
	}
